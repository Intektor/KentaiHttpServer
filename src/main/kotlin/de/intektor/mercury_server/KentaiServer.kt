...
import de.intektor.mercury_server.server.Commander
...
object MercuryServer {
    ...
    val fcmKey: String = Scanner(File("fcmKey.txt")).nextLine()

    fun startServer() {
        logger = Logger.getLogger("MercuryServer")
        try {
